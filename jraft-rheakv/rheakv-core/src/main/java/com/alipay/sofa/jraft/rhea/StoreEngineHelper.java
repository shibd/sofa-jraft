...
public final class StoreEngineHelper {
    ...
    public static void addKvStoreRequestProcessor(final RpcServer rpcServer, final StoreEngine engine) {
        rpcServer.registerProcessor(new KVCommandProcessor(RheakvRpc.GetRequest.class, engine));
        rpcServer.registerProcessor(new KVCommandProcessor(RheakvRpc.GetAndPutRequest.class, engine));
